...
typedef enum
{
    VENDOR_TRAP_DEFAULT 	=0x00, // Default trap . Agent send  use this trap when  
    ...
    Gen_RF4_LOST                = 14,
    Gen_RF4_ON                  = 15,
    Gen_TEMPERATURE_WARNING_OK	= 16,
    Gen_TEMPERATURE_WARNING     = 17,
    Gen_TEMPERATURE_ALARM_OK    = 18,
    Gen_TEMPERATURE_ALARM       = 19,
    Gen_COMB_AUDIO_OFF          = 20,
    Gen_COMB_AUDIO_ON           = 21,
    Gen_FAN_AV_ON               = 22,
    Gen_FAN_AV_OFF              = 23,
    Gen_FAN_AR_ON               = 24,
    Gen_FAN_AR_OFF              = 25,
    Gen_AMPLI_INPUT_ON          = 26,
    Gen_AMPLI_INPUT_OFF         = 27,
    Gen_AMPLI_TEMP_OK           = 28,
    Gen_AMPLI_TEMP_HIGH         = 29,
    Gen_SWR_WARNING_OK          = 30,
    Gen_SWR_WARNING             = 31,
    Gen_SWR_ALARM_OK            = 32,
    Gen_SWR_ALARM               = 33,
    Gen_AMPLI_OUTPUT_OVRLD_OK   = 34,
    Gen_AMPLI_OUTPUT_OVRLD      = 35,
    Gen_AMPLI_OUTPUT_LOW_OK     = 36,
    Gen_AMPLI_OUTPUT_LOW        = 37,
    Gen_INPUT_LOW               = 38
} SNMP_VENDOR_SPECIFIC_TRAP_NOTIFICATION_TYPE;
