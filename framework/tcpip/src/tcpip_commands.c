...
static int _Command_IPAddressSet(SYS_CMD_DEVICE_NODE* pCmdIO, int argc, char** argv)
{
    ...
    #if defined(TCPIP_NETWORK_DEFAULT_GATEWAY_2)
        if (TCPIP_Helper_StringToIPAddress(argv[2], &ipAddr))
        {
            addType2 = IP_ADDRESS_TYPE_IPV4;
        }
    #endif 
#if defined(TCPIP_STACK_USE_IPV6)
...
//    #if defined(TCPIP_NETWORK_DEFAULT_GATEWAY_2)
//        if (TCPIP_Helper_StringToIPAddress(argv[2], &ipGateway2)) //moi!!!
//        {
//            addType2 = IP_ADDRESS_TYPE_IPV4;
//        }
//    #endif
...
//        #if defined(TCPIP_NETWORK_DEFAULT_GATEWAY_2)
//
//            if(addType2 == IP_ADDRESS_TYPE_IPV4)
//            {
//                success2 = TCPIP_STACK_NetAddressGatewaySet(netH, &ipGateway2);//moi!!!
//
//            }
//        #endif 
