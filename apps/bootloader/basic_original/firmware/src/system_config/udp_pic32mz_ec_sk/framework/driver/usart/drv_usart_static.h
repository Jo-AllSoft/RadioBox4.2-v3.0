...
// *********************************************************************************************
// *********************************************************************************************
// Section: Byte Model Client Interface Headers for the Instance 5 of USART static driver
// *********************************************************************************************
// *********************************************************************************************

uint8_t DRV_USART5_ReadByte( void);
void DRV_USART5_WriteByte( const uint8_t byte);
unsigned int DRV_USART5_ReceiverBufferSizeGet(void);
unsigned int DRV_USART5_TransmitBufferSizeGet(void);
bool DRV_USART5_ReceiverBufferIsEmpty( void );
bool DRV_USART5_TransmitBufferIsFull(void);
