...
// Les fonctions page ne fonctionnent pas, se référer à la datasheet
void Write_EEPROM_Page(char* data, int start, int size)
{
...
void Read_EEPROM_Page(char* data, int start, int size)
{
    i2c_start();
    i2c_write(EEPROM1_WR);
    i2c_write((start>>8)&0xFF);
