...
{{.Init.msgInit = I2C_AD5593_INIT(0, 0b00111111, 0, 0b00000000, 0, 0b00000000, 0b00000000, 0b00000000), .ADC.msgRead = I2C_AD5593_START_READ, .add = I2C_AD5593_ADD},
 ...
 {.Init.msgInit = I2C_AD5593_INIT(1, 0b00000011, 0, 0b00000000, 0, 0b00000000, 0b00000100, 0b00000000), .ADC.msgRead = I2C_AD5593_START_READ, .add = I2C_AD5593_ADD},
};
...
void I2C_PT_Volume( PT_DEVICES d, float volume)
{
    ...
    I2C_Msgs_PT2314[d].msgWrite[0] = 0 | (vol & 0b111) | ((dizVol & 0b111) << 3);
...
/******Config Usine*******************/
    ...
    Nconfig[N].Device_IN[0].Aigue = 8;
    Nconfig[N].Device_IN[0].Basse= 0;
    Nconfig[N].Device_IN[0].Volume = 0;
    Nconfig[N].Device_IN[0].ReductionMax = 6.25;
    ...
    Nconfig[N].Device_IN[1].Aigue = 8;
    Nconfig[N].Device_IN[1].Basse= 0;
    Nconfig[N].Device_IN[1].Volume = -3.75;
    Nconfig[N].Device_IN[1].ReductionMax = 15.0;
    ...
    Nconfig[N].Device_IN[2].Aigue = 12;
    Nconfig[N].Device_IN[2].Basse= 4;
    Nconfig[N].Device_IN[2].Volume = 11.25;

    /********Micro2****************/
    Nconfig[N].Device_IN[3].Loudness = 0;
    Nconfig[N].Device_IN[3].Aigue = 12;
    Nconfig[N].Device_IN[3].Basse= 4;
    Nconfig[N].Device_IN[3].Volume = 11.25;

    /********Micro3****************/
    Nconfig[N].Device_IN[4].Loudness = 0;
    Nconfig[N].Device_IN[4].Aigue = 12;
    Nconfig[N].Device_IN[4].Basse= 4;
    Nconfig[N].Device_IN[4].Volume = 11.25;


    /********Micro4****************/
    Nconfig[N].Device_IN[5].Loudness = 0;
    Nconfig[N].Device_IN[5].Aigue = 12;
    Nconfig[N].Device_IN[5].Basse= 4;
    Nconfig[N].Device_IN[5].Volume = 11.25;
    ...
    Nconfig[N].Device_OUT[0].Aigue = 12;
    Nconfig[N].Device_OUT[0].Basse = 0;
    ...
    Nconfig[N].Device_OUT[1].Volume = 2.5;
...
void Upload_Audio_CSV(char* csv)
{
    ...
    char* TableParamtre[] = {"Name:","Gain;","Bass;","Treble;","Loudness;","ReductionMax;","Niveau Overload;","Detection Mute;","Time Muting;",
                    ...
                    do
                    {
                        ...
                        while(debugInfo[i+ Cpt_Match +j] != 0x3B);
                            switch(Param)
                            {
                                ...
                                case 1:
                                {
                                    Nconfig[Config_Used].Device_IN[jj].Volume = atof(str);
                                    
                                    float Somm_Volume = Nconfig[Config_Used].Device_IN[jj].Volume;
                                    float Perte;

                                    if((Somm_Volume > 0)&&(Somm_Volume <= 3.75))
                                    {
                                        Nconfig[Config_Used].Device_IN[jj].Gain = 3.75;            
                                    }
                                    else if((Somm_Volume > 3.75)&&(Somm_Volume <= 7.5))
                                    {
                                        Nconfig[Config_Used].Device_IN[jj].Gain = 7.5;               
                                    }
                                    else if((Somm_Volume > 7.5)&&(Somm_Volume <= 11.25))
                                    {
                                        Nconfig[Config_Used].Device_IN[jj].Gain = 11.25;               
                                    }
                                    else if(Somm_Volume <= 0)
                                    {
                                    ...
                                    Perte = Nconfig[Config_Used].Device_IN[jj].Gain - Somm_Volume;

                                    Nconfig[Config_Used].Device_IN[jj].Volume = -Perte; 
                                    if(Nconfig[Config_Used].Device_IN[jj].Volume < -30)
                                    {
                                        Nconfig[Config_Used].Device_IN[jj].Volume = -78.75;
                                    }   
