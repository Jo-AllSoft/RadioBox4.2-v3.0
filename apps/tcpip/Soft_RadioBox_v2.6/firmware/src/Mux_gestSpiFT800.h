...
#ifndef Mux_gestSpiFT800_H
#define	Mux_gestSpiFT800_H
...
void cmd2(uint32_t command);
void cmd_incrementn2(unsigned char n);
...
#define SELECT_ECRAN1   LATAbits.LATA6  //  COLONNE4   OUT
#define SELECT_ECRAN2   LATAbits.LATA7  //  COLONNE4   OUT
...
extern unsigned short cmd_offset2;
#define cmd_wait() cmd_offset=rd16(REG_CMD_WRITE);while(rd16(REG_CMD_READ) != CMD_OFFSET)
#define cmd_wait2() cmd_offset2=rd16(REG_CMD_WRITE);while(rd16(REG_CMD_READ) != CMD_OFFSET)
__inline unsigned short controle_offset(void);
    #define CMD_OFFSET controle_offset()
...
#define cmd_calibrate2() cmd(CMD_CALIBRATE);unsigned short cmd_calibrate_result_ptr2=CMD_OFFSET;cmd(0)
