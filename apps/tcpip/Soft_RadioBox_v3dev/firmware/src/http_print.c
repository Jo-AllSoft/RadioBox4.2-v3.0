...
void TCPIP_HTTP_Print_Config_Def(HTTP_CONN_HANDLE connHandle,uint16_t);
...
void TCPIP_HTTP_Print(HTTP_CONN_HANDLE connHandle,uint32_t callbackID)
{
    ...
    switch(callbackID)
    {
        ...
        case 0x000002a7:
			...
			break;
        case 0x000002a8:
			TCPIP_HTTP_Print_Config_Def(connHandle,0);
			break;
        case 0x000002a9:
			TCPIP_HTTP_Print_Config_Def(connHandle,1);
			break;
        case 0x000002aa:
			TCPIP_HTTP_Print_Config_Def(connHandle,2);
			break;
        case 0x000002ab:
			TCPIP_HTTP_Print_Config_Def(connHandle,3);
			break;
        case 0x000002ac:
			TCPIP_HTTP_Print_Config_Def(connHandle,4);
			break;
        default:
