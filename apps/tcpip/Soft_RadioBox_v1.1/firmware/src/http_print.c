...
void TCPIP_HTTP_Print_InSelect(HTTP_CONN_HANDLE connHandle,uint16_t);
...
void TCPIP_HTTP_Print_ReduSelect(HTTP_CONN_HANDLE connHandle,uint16_t);
...
void TCPIP_HTTP_Print(HTTP_CONN_HANDLE connHandle,uint32_t callbackID)
{
    ...
    switch(callbackID)
    {
        ...
        case 0x00000255:
			...
			break;
        case 0x00000258:
			TCPIP_HTTP_Print_value_But_Fader(connHandle);
			break;
        case 0x0000025b:
			TCPIP_HTTP_Print_Number_Midi1(connHandle);
			break;
        case 0x0000025c:
			TCPIP_HTTP_Print_Number_Midi2(connHandle);
			break;
        case 0x0000025d:
			TCPIP_HTTP_Print_Number_Midi3(connHandle);
			break;
        case 0x0000025e:
			TCPIP_HTTP_Print_Number_Midi_OFF1(connHandle);
			break;
        case 0x0000025f:
			TCPIP_HTTP_Print_Number_Midi_OFF2(connHandle);
			break;
        case 0x00000260:
			TCPIP_HTTP_Print_Number_Midi_OFF3(connHandle);
			break;
        case 0x00000261:
        ...
        case 0x00000264:
			...
			break;
        case 0x00000265:
			TCPIP_HTTP_Print_value_TOV(connHandle);
			break;
        case 0x00000266:
			TCPIP_HTTP_Print_TxtGainOut(connHandle);
			break;
        case 0x00000268:
			TCPIP_HTTP_Print_InSelect(connHandle,0);
			break;
        case 0x00000269:
			TCPIP_HTTP_Print_InSelect(connHandle,1);
			break;
        case 0x0000026a:
			TCPIP_HTTP_Print_InSelect(connHandle,3);
			break;
        case 0x0000026b:
			TCPIP_HTTP_Print_InSelect(connHandle,2);
			break;
        case 0x0000026c:
			TCPIP_HTTP_Print_InSelect(connHandle,4);
			break;
        case 0x0000026d:
			TCPIP_HTTP_Print_InSelect(connHandle,5);
			break;
        case 0x0000026e:
			TCPIP_HTTP_Print_InSelect(connHandle,6);
			break;
        case 0x0000026f:
        ...
        case 0x00000284:
			...
			break;
        case 0x00000285:
			TCPIP_HTTP_Print_ReduSelect(connHandle,0);
			break;
        case 0x00000286:
			TCPIP_HTTP_Print_ReduSelect(connHandle,1);
			break;
        case 0x00000287:
			TCPIP_HTTP_Print_ReduSelect(connHandle,2);
			break;
        case 0x00000288:
			TCPIP_HTTP_Print_ReduSelect(connHandle,3);
			break;
        case 0x00000289:
			TCPIP_HTTP_Print_ReduSelect(connHandle,4);
			break;
        case 0x0000028a:
			TCPIP_HTTP_Print_ReduSelect(connHandle,5);
			break;
        case 0x0000028b:
			TCPIP_HTTP_Print_ReduSelect(connHandle,6);
			break;
        case 0x0000028c:
			TCPIP_HTTP_Print_ReduSelect(connHandle,7);
			break;
        case 0x0000028d:
			TCPIP_HTTP_Print_ReduSelect(connHandle,8);
			break;
        case 0x0000028e:
			TCPIP_HTTP_Print_ReduSelect(connHandle,9);
			break;
        case 0x0000028f:
			TCPIP_HTTP_Print_ReduSelect(connHandle,10);
			break;
        case 0x00000290:
			TCPIP_HTTP_Print_ReduSelect(connHandle,11);
			break;
        case 0x00000291:
			TCPIP_HTTP_Print_ReduSelect(connHandle,12);
			break;
        case 0x00000292:
			TCPIP_HTTP_Print_ReduSelect(connHandle,13);
			break;
        case 0x00000293:
			TCPIP_HTTP_Print_ReduSelect(connHandle,14);
			break;
        case 0x00000294:
			TCPIP_HTTP_Print_ReduSelect(connHandle,15);
			break;
        case 0x00000295:
			TCPIP_HTTP_Print_ReduSelect(connHandle,16);
			break;
        case 0x00000297:
